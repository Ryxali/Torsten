...
/**
 * Objects from this pile represents all the loot on a single given tile. The
 * necessity for this being that several amounts of items can be present on a
 * single square. In practical terms this is very much the representation of a
 * dungeon chest or pile of gold.
 * 
 * @author Niklas L
...
public class LootPile extends SquareItem {
	...
	/**
	 * Constructs a new LootPile with the name, image and info specified and
	 * creates a new empty list of items it can store.
	 * 
	 * @param name
	 *            the name of the LootPile
	 * @param image
	 *            the image of the LootPile
	 * @param info
	 *            the info regarding the LootPile
	 */
	...
	/**
	 * Constructs a new LootPile with only a name and information regarding it.
	 * A LootPile created this way will display all the loot as though it's
	 * simply lying on the ground.
	 * 
	 * @param name
	 *            the name of the LootPile
	 * @param info
	 *            the info of the LootPile
	 */
	 ...
	 * 
	 * @return items.size(), the number of items this LootPile currently
	 *         contains.
	 */
	public int size() {
		return items.size();
