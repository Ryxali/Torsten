...
public class TextButton extends StandardButtonXY {
	 ...
	 * 
	 * @param title
	 *            the string to be drawn onto the button
	 * @param x
	 *            the x position of this button
	 * @param y
	 *            the y position of this button
	 * @param idleImg
	 *            the image representation of an idle button for this button
	 * @param hoverImg
	 *            the image representation of a hovering button for this button
	 * @param pressedImg
	 *            the image representation of a pressed button for this button
	 */
